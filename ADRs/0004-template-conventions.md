...
- Status: Accepted
- Date: 2026-07-15
- Scope: UniMCP and the conventions every engine started from it inherits
...
src/UniMCP.nim         umbrella
src/UniMCP/fibonacci.nim  hello-world (NimContracts)
...
- C symbol prefix: the library's own name in lower case (`unimcp_`, so
